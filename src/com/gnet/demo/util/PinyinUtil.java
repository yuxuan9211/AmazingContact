...
public class PinyinUtil {
	...
	/**
	 * @brief get Token
	 * @param character need parse character
	...
	private Token getToken(char character) {
		...
		{
			Log.e("PinyToHanZi", "PinyToHanZi parse Hanzi error " + e.getMessage());
		}
